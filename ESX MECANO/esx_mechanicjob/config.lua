...
Config.Zones = {
	...
	MechanicActions = {
		Pos   = { x = -198.074, y = -1341.292, z = 34.89 },
	...
	--Craft = {
		--Pos   = { x = -198.7107, y = -1315.33, z = 31.08 },
		--Size  = { x = 1.5, y = 1.5, z = 1.0 },
		--Color = { r = 204, g = 204, b = 0 },
		--Type  = 1
	--},
	...
	VehicleSpawnPoint = {
		Pos   = { x = -168.000, y = -1305.3468, z = 30.76 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Type  = -1
	},

	VehicleDeleter = {
		Pos   = { x = -179.1230, y = -1286.2618, z = 30.74 },
	...
	VehicleDelivery = {
		Pos   = { x = -200.8259, y = -1314.62, z = 21.153 },
